...
<div class="admin-page-header">
  ...
  <div style="display:flex;align-items:center;gap:12px;">
    <a href="athletes.php?<?php echo http_build_query(array_merge($_GET, ['export' => 'csv'])); ?>" style="background:#00B074;color:#fff;font-weight:700;font-size:0.85rem;padding:9px 16px;border-radius:6px;text-decoration:none;display:inline-flex;align-items:center;gap:7px;">
